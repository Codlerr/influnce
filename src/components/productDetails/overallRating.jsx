...
function OverallRating() {
  return (
    <div className=' w-2/5 border rounded-lg p-10'>
     <p>Overall Rating</p>
     ...
     <div className="flex flex-col items-center gap-2">
       ...
       <span className="flex items-center gap-4 rounded text-sm text-slate-500">
         <span
           className="flex gap-1 text-[#005342]"
           role="img"
       ...
       <span className="flex w-full flex-col gap-4 pt-6">
         <span className="flex w-full items-center gap-2">
           ...
           <progress
             ...
             max="100"
             value="75"
             className="block h-1 w-full overflow-hidden rounded bg-slate-100 [&::-webkit-progress-bar]:bg-slate-100 [&::-webkit-progress-value]:bg-[#005342] [&::-moz-progress-bar]:bg-[#005342]"
           >
             75%
           </progress>
